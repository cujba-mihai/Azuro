...
import { Appbar, IconButton, RadioButton, TextInput, Tooltip } from 'react-native-paper';
        ...
        <View style={{ alignItems: 'center', justifyContent: 'center', backgroundColor: 'white', }}>
            ...
            <View style={{ width: '100%', paddingLeft: 20, paddingRight: 20 }}>
                ...
                <TextInput
                    ...
                    mode='outlined'
                    right={<Tooltip title="Selected Camera">
                ...
                <HelpCenterIcon style={{ marginRight: 'auto', marginLeft: 'auto', marginBottom: 25, marginTop: 50 }} />
